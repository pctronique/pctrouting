...
$txttitle = "";
switch (true) {
  case $routing->indexbool("page2"):
    switch (true) {
      case $routing->indexbool("page2/item1"):
        $txttitle = "page2/item1";
        break;

      case $routing->indexbool("page2/item2"):
  ...
  case $routing->indexbool("page3"):
    switch (true) {
      case $routing->indexbool("page3/item1"):
        $txttitle = "page2/item1";
        break;

      case $routing->indexbool("page3/item2"):
        switch (true) {
          case $routing->indexbool("page3/item2/item1"):
            $txttitle = "page3/item2/item1";
            break;
    
          case $routing->indexbool("page3/item2/item2"):
    ...
    <menu>
      ...
      <ul class="all-bt-menu">
        <li class="bt-menu no-submenu">
          ...
          <li class="bt-menu no-submenu">
          <a href="<?= $routing->path("page1") ?>">page1</a>
          </li>
          <li class="bt-menu no-submenu">
          ...
          <li class="bt-menu no-submenu">
          <a href="<?= $routing->path("page1/item1") ?>">item11</a>
          </li>
          <li class="bt-menu no-submenu">
